          ...
          >
            ...
            <div className="hero-content text-neutral-content">
              <div className="max-w-max">
                ...
                <p className="my-5 text-sm md:text-base font-normal pr-64 text-white">
                  Our experience trainers will wrok with you to create a
                  personalized workout classes that fits your schedule fitness
          ...
          >
            ...
            <div className="hero-content text-neutral-content">
              <div className="max-w-max">
                ...
                <p className="my-5 text-sm md:text-base font-normal pr-64 text-white">
                  Our experience trainers will wrok with you to create a personalized workout classes that fits your schedule fitness level, and objectives.
                </p>
                <Link to="/services" className="btn bg-[#771333] text-white">
                  Explore Classes
                </Link>
